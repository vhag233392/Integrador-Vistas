...
function Motos(){
    ...
    <div className="flex flex-col items-center h-screen">
        <h1 className="text-2xl font-bold mb-5">
            Listo para trabajar en Motos!
        </h1>
        <div className="flex justify-center items-center h-screen">
            <div className="grid grid-cols-2 gap-5">
                <button onClick={showLoginForm} className="flex justify-center items-center">
                    <img src="../public/Motos/Añadir Moto.png" alt="Añadir" className="w-60 h-60" />
                </button>
                <button className="flex justify-center items-center">
                    <img src="../public/Motos/Visualizar Motos.png" alt="Visualizar" className="w-60 h-60" />
                </button>
                <button className="flex justify-center items-center">
